...
def run():
    ...
    points = genfromtxt('blastFurnaceSlagVsCCS.csv', delimiter=',')
    ...
    learning_rate_b = 0.0000000015 #0.0000009
    learning_rate_m = 0.0000000005
    initial_b = .1
    initial_m = .05
    ...
    plt.title('Blast Furnace Slag VS Concrete Compressive Strength')
